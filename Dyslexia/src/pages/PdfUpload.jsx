        ...
        <div style={styles.container}>
            ...
            <div style={styles.layout}>
                <div style={styles.panel}>
                    <h3 style={styles.panelTitle}>📝 Extracted Content</h3>
                    <div style={styles.box}>
                        {result.original || <span style={{ color: "#475569" }}>Extracted text will appear here...</span>}
                    </div>
                </div>
                ...
                <div style={styles.panel}>
                    ...
                    <div style={styles.box}>
                        {loading ? (
                            <p style={{ color: "#94a3b8" }}>⏳ Analyzing document content...</p>
                        ) : (
                            <>
                                {activeTab === "summary" && (
