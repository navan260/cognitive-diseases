            ...
            <main className="dys-sub-main">
                <header className="dys-sub-header">
                    ...
                    <div className="dys-panel" style={{ maxWidth: '600px', width: '100%', margin: '0 auto', textAlign: 'center' }}>
                        ...
                        {file && (
                            ...
                            >
                                {loading ? "⏳ Extracting Text..." : "🚀 Process PDF"}
                            </button>
                        )}
                    </div>
                </header>
                ...
                <div className="dys-layout-grid">
                    <section className="dys-panel">
                        <h3 className="dys-panel-title">📝 Extracted Content</h3>
                        <div className="dys-text-box">
                            {result.original || <span style={{ opacity: 0.4 }}>Extracted text will appear here...</span>}
                        </div>
                    </section>
                    ...
                    <section className="dys-panel">
                        ...
                        <div className="dys-text-box">
                            {loading ? (
                                <p style={{ opacity: 0.6 }}>⏳ Analyzing document content...</p>
                            ) : (
                                <>
                                    {activeTab === "summary" && (
